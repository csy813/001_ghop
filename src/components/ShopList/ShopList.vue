  ...
  <div class="shop_container">
    <ul class="shop_list"  v-if="shops.length">
      <li class="shop_li border-1px" v-for="(shop,index) in shops"
        ...
        <a>
          <span class="shop_left">
            <img class="shop_img" src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3095688394,92191646&fm=26&gp=0.jpg">
          </span>

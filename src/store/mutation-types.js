...
export const RECEIVE_GOODS = 'receive_shop_goods' // 接收商品数组
export const RECEIVE_INFO = 'receive_shop_info' // 接收商家评价数组
export const RECEIVE_RATINGS = 'receive_shop_ratings' // 接收商家信息
